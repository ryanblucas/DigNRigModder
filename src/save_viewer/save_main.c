...
{
	tool_event_t result = tool_select_handle_mouse_click(select_tool, m1_down, x, y, 0, y_pos);
	switch (result)
	{
...
{
	tool_event_t result = tool_select_handle_mouse_move(select_tool, m1_down, x, y, 0, y_pos);
